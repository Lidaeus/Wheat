ptf ^
*COTTON CULTIVAR COEFFICIENTS: CRGRO046 MODEL
!
! COEFF   DEFINITIONS
! =====   ===========
...
!         (mg CO2/m2-s)---from Reddy Adv. Agron. 1997?
...
IB0001 Deltapine 77         2 CO0001 23.00 0.010 ^EMF^ ^FLH^ ^FLD^ ^SDP^ 75.00 ^LMX^ ^SAR^ ^SZF^ ^XFR^ 0.180 ^SDR^ ^SPV^ ^PDR^ 70.00 0.153 0.120
